...
type CommonsRunner struct {
	...
	// CreatedAt is the timestamp when the runner was created
	CreatedAt *string `json:"created_at,omitempty"`
	// Id is the unique identifier for the runner
	...
	// Deprecated: runner sets are organization-global — never read this for logic. It is only still stamped on create (any connected GitHub org, not \"the serving org\") so previous releases keep working after a code rollback.
...
func (o *CommonsRunner) GetMeta() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *CommonsRunner) GetMetaOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Meta) {
...
func (o *CommonsRunner) SetMeta(v map[string]interface{}) {
	o.Meta = v
}
...
func (o *CommonsRunner) UnmarshalJSON(data []byte) (err error) {
	varCommonsRunner := _CommonsRunner{}

	err = json.Unmarshal(data, &varCommonsRunner)
