...
type CommonsStorage struct {
	...
	// IOPS is the provisioned IOPS of the storage.
	...
	// Throughput is the provisioned throughput of the storage in MiB/s.
...
func (o *CommonsStorage) UnmarshalJSON(data []byte) (err error) {
	varCommonsStorage := _CommonsStorage{}

	err = json.Unmarshal(data, &varCommonsStorage)
