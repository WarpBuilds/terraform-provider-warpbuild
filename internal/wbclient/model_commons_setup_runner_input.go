...
func (o *CommonsSetupRunnerInput) GetPoolSize() int32 {
...
// and a boolean to check if the value has been set.
func (o *CommonsSetupRunnerInput) GetPoolSizeOk() (*int32, bool) {
	if o == nil || IsNil(o.PoolSize) {
		return nil, false
	}
...
func (o *CommonsSetupRunnerInput) HasPoolSize() bool {
	if o != nil && !IsNil(o.PoolSize) {
		return true
	}
...
func (o *CommonsSetupRunnerInput) SetPoolSize(v int32) {
	o.PoolSize = &v
}

// GetProviderId returns the ProviderId field value if set, zero value otherwise.
func (o *CommonsSetupRunnerInput) GetProviderId() string {
...
// and a boolean to check if the value has been set.
func (o *CommonsSetupRunnerInput) GetProviderIdOk() (*string, bool) {
	if o == nil || IsNil(o.ProviderId) {
		return nil, false
	}
...
func (o *CommonsSetupRunnerInput) HasProviderId() bool {
	if o != nil && !IsNil(o.ProviderId) {
		return true
	}
...
func (o *CommonsSetupRunnerInput) SetProviderId(v string) {
	o.ProviderId = &v
}
...
func (o *CommonsSetupRunnerInput) UnmarshalJSON(data []byte) (err error) {
	varCommonsSetupRunnerInput := _CommonsSetupRunnerInput{}

	err = json.Unmarshal(data, &varCommonsSetupRunnerInput)
