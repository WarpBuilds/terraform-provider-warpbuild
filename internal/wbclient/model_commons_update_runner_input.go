...
type CommonsUpdateRunnerInput struct {
	...
	// Labels are updated custom tags for runner selection
	Labels []string `json:"labels,omitempty"`
	// Name is the new unique identifier for the runner
...
func (o *CommonsUpdateRunnerInput) GetPoolSize() int32 {
...
// and a boolean to check if the value has been set.
func (o *CommonsUpdateRunnerInput) GetPoolSizeOk() (*int32, bool) {
	if o == nil || IsNil(o.PoolSize) {
		return nil, false
	}
...
func (o *CommonsUpdateRunnerInput) HasPoolSize() bool {
	if o != nil && !IsNil(o.PoolSize) {
		return true
	}
...
func (o *CommonsUpdateRunnerInput) SetPoolSize(v int32) {
	o.PoolSize = &v
}
...
func (o *CommonsUpdateRunnerInput) UnmarshalJSON(data []byte) (err error) {
	varCommonsUpdateRunnerInput := _CommonsUpdateRunnerInput{}

	err = json.Unmarshal(data, &varCommonsUpdateRunnerInput)
