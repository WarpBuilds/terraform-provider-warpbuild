...
type CommonsRunnerSetConfiguration struct {
	...
	// CapacityType specifies spot or on-demand instances
	CapacityType *string `json:"capacity_type,omitempty"`
	// Image is the base image for the runner (e.g., ubuntu-2404, macos-14)
	Image *string `json:"image,omitempty"`
	// Sku is the WarpBuild SKU identifier for managed runners
...
func (o *CommonsRunnerSetConfiguration) UnmarshalJSON(data []byte) (err error) {
	varCommonsRunnerSetConfiguration := _CommonsRunnerSetConfiguration{}

	err = json.Unmarshal(data, &varCommonsRunnerSetConfiguration)
