...
type CommonsByocSku struct {
	...
	// IMDSv2Required when set to true, enforces IMDSv2 and disables IMDSv1 for EC2 instances. This is only applicable for AWS EC2 based runners. Passing this for other providers will have no effect. This helps prevent Server Side Request Forgery (SSRF) attacks. Default is false (both IMDSv1 and IMDSv2 are allowed).
	Imdsv2Required *bool `json:"imdsv2_required,omitempty"`
	// InstanceTypes lists acceptable EC2/GCE/Azure instance types
	InstanceTypes []string `json:"instance_types,omitempty"`
	// IsPublic indicates whether instances should have public IPs
	...
	// RoleARN is the AWS IAM role ARN for assuming cloud permissions
...
// GetImdsv2Required returns the Imdsv2Required field value if set, zero value otherwise.
func (o *CommonsByocSku) GetImdsv2Required() bool {
	if o == nil || IsNil(o.Imdsv2Required) {
		var ret bool
		return ret
	}
	return *o.Imdsv2Required
}

// GetImdsv2RequiredOk returns a tuple with the Imdsv2Required field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CommonsByocSku) GetImdsv2RequiredOk() (*bool, bool) {
	if o == nil || IsNil(o.Imdsv2Required) {
		return nil, false
	}
	return o.Imdsv2Required, true
}

// HasImdsv2Required returns a boolean if a field has been set.
func (o *CommonsByocSku) HasImdsv2Required() bool {
	if o != nil && !IsNil(o.Imdsv2Required) {
		return true
	}
...
// SetImdsv2Required gets a reference to the given bool and assigns it to the Imdsv2Required field.
func (o *CommonsByocSku) SetImdsv2Required(v bool) {
	o.Imdsv2Required = &v
}
...
func (o CommonsByocSku) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Imdsv2Required) {
		toSerialize["imdsv2_required"] = o.Imdsv2Required
	}
...
func (o *CommonsByocSku) UnmarshalJSON(data []byte) (err error) {
	varCommonsByocSku := _CommonsByocSku{}

	err = json.Unmarshal(data, &varCommonsByocSku)
	...
	*o = CommonsByocSku(varCommonsByocSku)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "imdsv2_required")
